...
#define DEFINE_TIMER_VARIABLES                                                                              \
	...
	double _bench_cycles_x, _bench_cycles_mean, _bench_cycles_delta, _bench_cycles_M2; \
...
#define PRINT_TIMER_AVG(op_name,file) \
	tofile_double_2(((double) _bench_time_cumulative) / 1000000.0,((double) _bench_cycles_cumulative),file);
...
#define TIME_OPERATION_ITERATIONS(op, op_name, it, file) \
	{                                              \
		DEFINE_TIMER_VARIABLES                     \
		INITIALIZE_TIMER                           \
		for (int i = 0; i < (it); i++) {           \
		...
		PRINT_TIMER_AVG(op_name,file)              \
	}

#define TIME_OPERATION_SECONDS(op, op_name, secs, file)                 \
	{                                                             \
		DEFINE_TIMER_VARIABLES                                    \
		INITIALIZE_TIMER                                          \
